          ...
          <section id="test" className="copy-section scroll-mt-6 border-y border-line bg-paper py-16 sm:py-24">
            <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_auto] lg:items-center">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 leading-7 text-slate-600">For a different test framing, try the five-round <a href="/reflex-test/" className="font-bold text-action">reflex test</a>. To turn your baseline into a repeatable routine, use the guide on <a href="/how-to-increase-reaction-time/" className="font-bold text-action">how to increase reaction time</a>.</p>
              </div>
